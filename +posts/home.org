...
#+begin_quote
The goal was to find the no. of times, *a particular digit appeared*
(occurrences) in a *very large positive number*.
#+end_quote
...
:END:
    ...
    #   <a href="https://github.com/imahajanshubham/docs/blob/master/%2Bposts/home.org"><p class="plus">👁</p></a>
    # </div>
#+begin_export html
  <a class="fixedbutton btn btn-social-icon btn-github" onclick="_gaq.push(['_trackEvent', 'btn-social-icon', 'click', 'btn-github']);"><span class="fa fa-github"></span></a>
