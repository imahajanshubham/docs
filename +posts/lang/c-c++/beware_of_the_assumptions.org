...
#+begin_export html
  <ul class="pager">
      <li class="next">
          <a href="https://imahajanshubham.github.io/docs/lang/c-c++/structures.html" class="btn btn-neutral float-right" title="Structures And Pointer" accesskey="n" rel="next">next <span class="fa fa-arrow-circle-right"></span></a>
      </li>
      <li class="previous">
